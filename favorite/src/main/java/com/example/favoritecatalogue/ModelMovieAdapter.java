    ...
    public void onBindViewHolder(@NonNull final ModelMovieAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent movieMoveIntent = new Intent(viewHolder.itemView.getContext(), FavoriteDetailActivity.class);
                movieMoveIntent.setData(uriMovieAdapter);
                movieMoveIntent.putExtra(FavoriteDetailActivity.EXTRA_KEY_Movie, listModelMovie.get(viewHolder.getAdapterPosition()));
