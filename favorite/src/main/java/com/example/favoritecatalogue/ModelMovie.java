...
public class ModelMovie implements Parcelable {
    ...
    public ModelMovie(Cursor cursor) {
        this.movie_id = getField(cursor, FavoriteDBContract.ItemField.ITEM_ID);
        this.movie_name = getField(cursor, FavoriteDBContract.ItemField.ITEM_NAME);
        this.movie_date = getField(cursor, FavoriteDBContract.ItemField.ITEM_DATE);
        this.movie_score = getField(cursor, FavoriteDBContract.ItemField.ITEM_SCORE);
        this.movie_popularity = getField(cursor, FavoriteDBContract.ItemField.ITEM_POPULARITY);
        this.movie_synopsis = getField(cursor, FavoriteDBContract.ItemField.ITEM_SYNOPSIS);
        this.movie_poster = getField(cursor, FavoriteDBContract.ItemField.ITEM_POSTER);
        this.movie_backdrop = getField(cursor, FavoriteDBContract.ItemField.ITEM_BACKDROP);
    }
