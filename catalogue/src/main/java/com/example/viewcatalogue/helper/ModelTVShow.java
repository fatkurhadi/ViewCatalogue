...
public class ModelTVShow implements Parcelable {
    ...
    public ModelTVShow(Cursor cursor){
        this.tv_show_id = getField(cursor, CatalogueDBContract.ItemField.ITEM_ID);
        this.tv_show_name = getField(cursor, CatalogueDBContract.ItemField.ITEM_NAME);
        this.tv_show_date = getField(cursor, CatalogueDBContract.ItemField.ITEM_DATE);
        this.tv_show_score = getField(cursor, CatalogueDBContract.ItemField.ITEM_SCORE);
        this.tv_show_popularity = getField(cursor, CatalogueDBContract.ItemField.ITEM_POPULARITY);
        this.tv_show_synopsis = getField(cursor, CatalogueDBContract.ItemField.ITEM_SYNOPSIS);
        this.tv_show_poster = getField(cursor, CatalogueDBContract.ItemField.ITEM_POSTER);
        this.tv_show_backdrop = getField(cursor, CatalogueDBContract.ItemField.ITEM_BACKDROP);
    }
