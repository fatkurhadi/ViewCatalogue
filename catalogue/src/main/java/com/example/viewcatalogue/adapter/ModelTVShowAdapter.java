    ...
    public void onBindViewHolder(@NonNull final ModelTVShowAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent tvShowMoveIntent = new Intent(viewHolder.itemView.getContext(), CatalogueDetailActivity.class);
                tvShowMoveIntent.setData(uriTVShowAdapter);
                tvShowMoveIntent.putExtra(CatalogueDetailActivity.EXTRA_KEY_TVShow, listModelTVShow.get(viewHolder.getAdapterPosition()));
